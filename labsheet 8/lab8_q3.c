...
unsigned int count, sec, min,sec0,min0,sec1,min1; 
...
sec1 = sec / 10;	
	...
	min1 = min/10;
      lcd_cmd(0x80); 
	    lcd_cmd(0x01);
      lcd_write_char(min1+48); // display tens digit of minute
	    lcd_cmd(0x06);
      lcd_write_char(min0+48); // display ones digit of minute
	lcd_cmd(0x06);
      lcd_write_char(':'); // display colon
	lcd_cmd(0x06);
      lcd_write_char(sec1+48); // display tens digit of second
	lcd_cmd(0x06);
      lcd_write_char(sec0+48); // display ones digit of second
	lcd_cmd(0x06);
